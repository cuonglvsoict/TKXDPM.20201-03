...
public class SearchResultScreenHandler extends BaseScreenHandler implements Initializable {
	...
	public SearchResultScreenHandler(Stage primaryStage, String fxmlPath, BaseController bController) throws IOException {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		List<Station> stations = (List<Station>) AppData.getAttribute("search_station_result");
		List<Bike> bikes = (List<Bike>) AppData.getAttribute("search_bike_result");
