...
public class SQLScript {
	...
	/**
	 * search station by station id, address, name
	 */
	public static final String SQL_SEARCH_STATION = "select * from station where station_id like ? or address like ? or station_name like ?;";

	/**
	 * search bike by id, name
	 */
